...
describe('UpdateDescriptionOfExistingExperiment', function () {
    it('PUT /experiments/:id with a valid id and a body only containing the field "description" must only update the description of an experiment.', async () => {
