...
describe('UpdateStartDateOfExistingExperiment', function () {
    it('PUT /experiments/:id with a valid id and a body only containing the field "startDate" must only update the startDate of an experiment.', async () => {
